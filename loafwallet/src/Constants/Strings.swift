...
enum S {
    ...
    enum Scanner {
        static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value: "**Camera Flash**", comment: "Scan Fastcoin address camera flash toggle")
    }
    ...
    enum Send {
        ...
        static let invalidAddressMessage = NSLocalizedString("Send.invalidAddressMessage", value: "**The destination address is not a valid Fastcoin address.**", comment: "Invalid address alert message")
        static let invalidAddressOnPasteboard = NSLocalizedString("Send.invalidAddressOnPasteboard", value: "**Pasteboard does not contain a valid Fastcoin address.**", comment: "Invalid address on pasteboard message")
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value: "**Fastwallet is not allowed to access the camera**", comment: "Camera not allowed alert title")
        ...
        enum UsedAddress {
            ...
            static let firstLine = NSLocalizedString("Send.UsedAddress.firstLine", value: "**Fastcoin addresses are intended for single use only.**", comment: "Adress already used alert message - first part")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value: "**DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Fastwallet's keychain data and steal your Fastcoin! Wipe this wallet immediately and restore on a secure device.**", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value: "**DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Fastwallet's keychain data and steal your Fastcoin. Please only use Fastwallet on a non-jailbroken device.**", comment: "Jailbreak warning message")
    ...
    enum TransactionDetails {
        ...
        static let txHashHeader = NSLocalizedString("TransactionDetails.txHashHeader", value: "**Fastcoin Transaction ID**", comment: "Transaction ID header")
    ...
    enum BuyCenter {
      static let title = NSLocalizedString("BuyCenter.title", value: "**Buy Fastcoin**", comment: "Buy Center Title")
      static let buyModalTitle = NSLocalizedString("BuyCenter.ModalTitle", value: "**Buy Ƒastcoin**", comment: "Buy Modal Title")
      enum Cells {
        static let simplexTitle = NSLocalizedString("BuyCenter.simplexTitle", value: "**Simplex**", comment: "Simplex Title")
        static let simplexFinancialDetails = NSLocalizedString("BuyCenter.simplexFinancialDetails", value: "**• Get Fastcoin in 5 mins!\n• Buy Fastcoin via credit card\n• Passport or State ID**", comment: "Simplex buy financial details")
        static let changellyTitle = NSLocalizedString("BuyCenter.changellyTitle", value: "**Changelly**", comment: "Changelly Title")
        static let changellyFinancialDetails = NSLocalizedString("BuyCenter.changellyFinancialDetails", value: "**• Change Fastcoin for other cryptos\n• No ID Required\n• Buy via credit card\n• Global coverage**", comment: "Changelly buy financial details")
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value: "**Protects your Fastwallet from unauthorized users.**", comment: "PIN button description")
            static let touchIdTitle = NSLocalizedString("SecurityCenter.touchIdTitle", value: "**Touch ID**", comment: "Touch ID button title")
            static let touchIdDescription = NSLocalizedString("SecurityCenter.touchIdDescription", value: "**Conveniently unlock your Fastwallet and send money up to a set limit.**", comment: "Touch ID/FaceID button description")
            static let paperKeyTitle = NSLocalizedString("SecurityCenter.paperKeyTitle", value: "**Paper Key**", comment: "Paper Key button title")
            static let paperKeyDescription = NSLocalizedString("SecurityCenter.paperKeyDescription", value: "**The only way to access your Fastcoin if you lose or upgrade your phone.**", comment: "Paper Key button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value: "**Your PIN will be used to unlock your Fastwallet and send money.**", comment: "PIN creation info.")
        ...
        static let caption = NSLocalizedString("UpdatePin.caption", value: "**Remember this PIN. If you forget it, you won't be able to access your Fastcoin.**", comment: "Update PIN caption text")
    ...
    enum RecoverWallet {
        ...
        static let intro = NSLocalizedString("RecoverWallet.intro", value: "**Recover your Fastwallet with your paper key.**", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value: "**My Fastwallet**", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let label = NSLocalizedString("TouchIdSettings.label", value: "**Use your fingerprint to unlock your Fastwallet and send money up to a set limit.**", comment: "Touch Id screen label")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value: "**Enable Touch ID for Fastwallet**", comment: "Touch id switch label.")
    ...
    enum FaceIDSettings {
        ...
        static let label = NSLocalizedString("FaceIDSettings.label", value: "**Use your face to unlock your Fastwallet and send money up to a set limit.**", comment: "Face ID screen label")
        static let switchLabel = NSLocalizedString("FaceIDSettings.switchLabel", value: "**Enable Face ID for Fastwallet**", comment: "Face id switch label.")
    ...
    enum Settings {
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "**Are you enjoying Fastwallet?**", comment: "Are you enjoying Fastwallet alert message body")
        ...
        static let litewalletVersion = NSLocalizedString("Settings.litewallet.version", value: "**Fastwallet Version:**", comment: "Fastwallet version")
        static let litewalletEnvironment = NSLocalizedString("Settings.litewallet.environment", value: "**Fastwallet Environment:**", comment: "Fastwallet environment")
        static let socialLinks = NSLocalizedString("Settings.socialLinks", value: "**Social Links:**", comment: "Fastwallet Social links")
    }
    ...
    enum About {
        ...
        static let footer = NSLocalizedString("About.footer", value: "**Made by the FastWallet Team\nof the\nFastcoin Project\n%1$@**", comment: "About screen footer")
    }
    ...
    enum PushNotifications {
        ...
        static let body = NSLocalizedString("PushNotifications.body", value: "**Turn on notifications to receive special messages from Fastwallet in the future.**", comment: "Push notifications settings view body")
    ...
    enum DefaultCurrency {
        ...
        static let bitcoinLabel = NSLocalizedString("DefaultCurrency.bitcoinLabel", value: "**Fastcoin Display Unit**", comment: "Fastcoin denomination picker label")
    ...
    enum RequestAnAmount {
        static let title = NSLocalizedString("RequestAnAmount.title", value: "**Request an Amount**", comment: "Request a specific amount of Fastcoin")
    ...
    enum MenuButton {
        ...
        static let buy = NSLocalizedString("MenuButton.buy", value: "**Buy Fastcoin**", comment: "Buy Fastcoin title")
    }
    ...
    enum StartViewController {
        ...
        static let message = NSLocalizedString("StartViewController.message", value: "**The most secure and safest way to use Fastcoin.**", comment: "Start view message")
    }
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "**Open the Fastwallet iPhone app to set up your wallet.**", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum PaperKey {
            ...
            static let body = NSLocalizedString("Prompts.PaperKey.body", value: "**Your Paper Key must be kept in a safe place. It is the only way modify or restore your Fastwallet or transfer your Fastcoin. Please write it down.**", comment: "Warning about paper key.")
        }
        enum SetPin {
            static let title = NSLocalizedString("Prompts.SetPin.title", value: "**Set PIN**", comment: "Set PIN prompt title.")
            static let body = NSLocalizedString("Prompts.SetPin.body", value: "**Fastwallet requires a 6-digit PIN. Please set and store your PIN in a safe place.**", comment: "Upgrade PIN prompt body.")
        }
        ...
        enum ShareData {
            ...
            static let body = NSLocalizedString("Prompts.ShareData.body", value: "**Help improve Fastwallet by sharing your anonymous data with us**", comment: "Share data prompt body")
        }
        enum FaceId {
    ...
    enum PaymentProtocol {
        enum Errors {
            ...
            static let smallPayment = NSLocalizedString("PaymentProtocol.Errors.smallPayment", value: "**Fastcoin payments can't be less than %1$@.**", comment: "Amount too small error message")
            static let smallTransaction = NSLocalizedString("PaymentProtocol.Errors.smallTransaction", value: "**Fastcoin transaction outputs can't be less than $@.**", comment: "Output too small error message.")
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "**Fastwallet does not have permission to access location services.**", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "**Your Fastwallet Wallet**", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "**Importing a wallet transfers all the money from your other wallet into your Fastwallet wallet using a single transaction.**", comment: "Import wallet intro screen message")
        ...
        static let confirm = NSLocalizedString("Import.confirm", value: "**Send %1$@ from this private key into your wallet? The Fastcoin network will receive a fee of %2$@.**", comment: "Sweep private key confirmation message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "**%1$@ is requesting authentication using your Fastcoin wallet**", comment: "<sitename> is requesting authentication using your Fastcoin wallet")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "**Starting or recovering another wallet allows you to access and manage a different Fastwallet wallet on this device.**", comment: "Start wipe wallet view message")
        ...
        static let warningDescription = NSLocalizedString("WipeWallet.warningDescription", value: "**Your FastWallet is empty. Resetting will delete the old private key and wipe the app data.\n\nAfter the reset, be prepared to record the new 12 words and keep them in a very secure place.\n\nNo FastWallet developers can retrieve this seed for you.**", comment: "Warning description")
    ...
    enum NodeSelector {
        ...
        static let title = NSLocalizedString("NodeSelector.title", value: "**Fastcoin Nodes**", comment: "Node Selector view title")
    ...
    enum Welcome {
        static let title = NSLocalizedString("Welcome.title", value: "**Welcome to Fastwallet**", comment: "Welcome view title")
        static let body = NSLocalizedString("Welcome.body", value: "**Fastwallet now has a brand new look and some new features.\n\nAll coins are displayed in lites (ƒ). 1 Fastcoin (Ƒ) = 1000 lites (ƒ).**", comment: "Welcome view body text")
    }
}
