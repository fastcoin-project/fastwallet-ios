...
class ConfirmationViewController : UIViewController, ContentBoxPresenter {
    ...
    private let sendButton = ShadowButton(title: S.Confirmation.send, type: .flatFastcoinBlue, image: (LAContext.biometricType() == .face ? #imageLiteral(resourceName: "FaceId") : #imageLiteral(resourceName: "TouchId")))
